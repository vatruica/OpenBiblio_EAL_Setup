This is the modified version of the layout.php file located in /var/www/openbiblio/shared/layout.php

See lines 31, 32, 35, 36 for the modifications.
 ...
 */
  ...
  //here its getting the layout for generating the pdf
  // normally, when printing labels is $_REQUEST["name"] = labels 
  // but we want A4_barcode_1X16 because it displays the dimensions we want BUT NOT WHAT WE WANT
  $filename = '../layouts/'.$_REQUEST["name"].'.php';
  if (!is_readable($filename)) {
    # replaced filename with our desired template
    $filename = '../layouts/default/'.'A4_barcode_1x16'.'.php';
  }
  assert('is_readable($filename)');
  # replaced classname with our desired template name
  $classname = 'Layout_'.'A4_barcode_1x16';
